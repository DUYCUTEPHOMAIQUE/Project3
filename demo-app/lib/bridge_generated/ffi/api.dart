...
String generateIdentityKeyPair() =>
    E2EECore.instance.api.crateFfiApiGenerateIdentityKeyPair();
...
String getPublicKeyHexFromJson({required String identityBytesJson}) => E2EECore
    .instance.api
    .crateFfiApiGetPublicKeyHexFromJson(identityBytesJson: identityBytesJson);
...
String generatePrekeyBundle(
        {required String identityBytesJson,
        required int signedPrekeyId,
        int? oneTimePrekeyId}) =>
    E2EECore.instance.api.crateFfiApiGeneratePrekeyBundle(
        identityBytesJson: identityBytesJson,
...
String createSessionInitiator(
        {required String identityBytesJson,
        required String prekeyBundleJson}) =>
    E2EECore.instance.api.crateFfiApiCreateSessionInitiator(
        identityBytesJson: identityBytesJson,
...
String createSessionResponder(
    ...
    E2EECore.instance.api.crateFfiApiCreateSessionResponder(
        identityBytesJson: identityBytesJson,
        signedPrekeyId: signedPrekeyId,
        oneTimePrekeyId: oneTimePrekeyId,
        aliceIdentityHex: aliceIdentityHex,
        aliceEphemeralPublicKeyHex: aliceEphemeralPublicKeyHex);
...
String encryptMessage(
    ...
    E2EECore.instance.api
        .crateFfiApiEncryptMessage(sessionId: sessionId, plaintext: plaintext);
...
Uint8List decryptMessage(
    ...
    E2EECore.instance.api.crateFfiApiDecryptMessage(
        sessionId: sessionId, envelopeBase64: envelopeBase64);
...
void closeSession({required String sessionId}) =>
    E2EECore.instance.api.crateFfiApiCloseSession(sessionId: sessionId);
